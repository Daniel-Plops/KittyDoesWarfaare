...
pygame.mixer.music.load('GAM/menuMusic.mp3')
pygame.mixer.music.play(-1)
ow = pygame.mixer.Sound('GAM/pain sound.mp3')
munch = pygame.mixer.Sound('GAM/munch.mp3')
click = pygame.mixer.Sound('GAM/click.mp3')
lose = pygame.mixer.Sound('GAM/lose.mp3')
yay = pygame.mixer.Sound('GAM/yay.mp3')
...
rect_x, rect_y = 10, 70
test = pygame.image.load('GAM/test.gif')
startScreen = pygame.image.load('GAM/1.png')
playScreen = pygame.image.load('GAM/PLAY.png')
helpScreen1 = pygame.image.load('GAM/inst1.png')
helpScreen2 = pygame.image.load('GAM/inst2.png')
helpScreen3 = pygame.image.load('GAM/inst3.png')
credScreen = pygame.image.load('GAM/creds.png')
overScreen = pygame.image.load('GAM/gamover.png')
winScreen = pygame.image.load('GAM/win.png')

twins = pygame.image.load('GAM/besttwin.png')
hoverflower = pygame.image.load('GAM/besttwin.png')
hoverflower.set_alpha(128)
kitty = pygame.image.load('GAM/kitty.png')
hoverkitty = pygame.image.load('GAM/kitty.png')
hoverkitty.set_alpha(128)
melody = pygame.image.load('GAM/melody.png')
hovermelody = pygame.image.load('GAM/melody.png')
hovermelody.set_alpha(128)
purin = pygame.image.load('GAM/purin.png')
hoverpurin = pygame.image.load('GAM/purin.png')
hoverpurin  .set_alpha(128)
sam = pygame.image.load('GAM/sam.png')
hoversam = pygame.image.load('GAM/sam.png')
hoversam.set_alpha(128)
zomb = pygame.image.load('GAM/zomb.png')
pochacco = pygame.image.load('GAM/pochacco.png')
keroppi = pygame.image.load('GAM/keroppi.png')
kuromi = pygame.image.load('GAM/kuromi.png')
bossPic = pygame.image.load('GAM/boss.png')
twins1 = pygame.image.load('GAM/twins1.png')
twins2 = pygame.image.load('GAM/twins2.png')
kitty1 = pygame.image.load('GAM/kitty1.png')
kitty2 = pygame.image.load('GAM/kitty2.png')
melody1 = pygame.image.load('GAM/melody1.png')
melody2 = pygame.image.load('GAM/melody2.png')
purin1 = pygame.image.load('GAM/purin1.png')
purin2 = pygame.image.load('GAM/purin2.png')
sam1 = pygame.image.load('GAM/sam1.png')
sam2 = pygame.image.load('GAM/sam2.png')

starPic = pygame.image.load('GAM/star.png')
bow1f = pygame.image.load('GAM/bow1.png')
bow2f = pygame.image.load('GAM/bow2.png')
bow1 = pygame.transform.scale(bow1f, (40, 20))
bow2 = pygame.transform.scale(bow2f, (40, 20))
shovel = pygame.image.load('GAM/shovel.png')
...
while True: 
    ...
    if play:
        ...
        if kers >= 12 and not boss:
                hold = 99999999999
                pygame.mixer.music.load('GAM/bossMusic.mp3')
                pygame.mixer.music.play(-1)
                boss = True
        if spawntimer <= 0:
            if hold > 20:
    ...
    for ev in pygame.event.get(): 
        ...
        if ev.type == pygame.MOUSEBUTTONDOWN:
            if start and 620>x>360 and 390>y>330:
                start = False
                play = True
                pygame.mixer.music.load('GAM/fightMusic.mp3')
                pygame.mixer.music.play(-1)
